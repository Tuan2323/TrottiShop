 ...
 */
final class Version20200916141923 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trotti CHANGE prix prix VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trotti CHANGE prix prix INT NOT NULL');
    }
}
